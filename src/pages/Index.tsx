          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                Более 15 лет помогаю студентам раскрывать потенциал и достигать академических высот. 
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="border-none shadow-md hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  Кандидат педагогических наук, МГУ им. М.В. Ломоносова. 
                  Специализация: Инновационные образовательные технологии.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-none shadow-md hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground">
                  15+ лет преподавания в ведущих российских вузах. 
                  Автор 3 учебных пособий и 20+ научных публикаций.
                </p>
              </CardContent>
            </Card>
